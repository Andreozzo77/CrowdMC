...
final class ItemTranslator{
	...
	public function toNetworkId(int $internalId, int $internalMeta) : array{
		...
		Server::getInstance()->getLogger()->error("Unmapped ID/metadata translation " . $internalId . ":" . $internalMeta);
		return [$this->simpleCoreToNetMapping[array_rand($this->simpleCoreToNetMapping)], 0];
	}
