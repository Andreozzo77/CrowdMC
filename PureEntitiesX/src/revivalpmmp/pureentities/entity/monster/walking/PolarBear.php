...
class PolarBear extends WalkingMonster implements Monster{
	...
	public function getDrops() : array{
		...
		if($this->isLootDropAllowed()){
			if(\kenygamer\Core\Main::mt_rand(0, 3) > 0){
				array_push($drops, Item::get(Item::RAW_FISH, 0, \kenygamer\Core\Main::mt_rand(0, 2)));
			}else{
				array_push($drops, Item::get(Item::RAW_SALMON, 0, \kenygamer\Core\Main::mt_rand(0, 2)));
			}
		}
		return $drops;
	}
