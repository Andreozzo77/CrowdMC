...
trait Tameable{
	...
	public function attemptToTame(Player $player) : bool{
		...
		$tameSuccess = \kenygamer\Core\Main::mt_rand(0, $this->tameChance - 1) === 0;
	...
	private function getPositionNearOwner(Player $owner, BaseEntity $pet) : Vector3{
		$x = $owner->x + (\kenygamer\Core\Main::mt_rand(2, 3) * (\kenygamer\Core\Main::mt_rand(0, 1) == 1 ?: -1));
		$z = $owner->z + (\kenygamer\Core\Main::mt_rand(2, 3) * (\kenygamer\Core\Main::mt_rand(0, 1) == 1 ?: -1));
