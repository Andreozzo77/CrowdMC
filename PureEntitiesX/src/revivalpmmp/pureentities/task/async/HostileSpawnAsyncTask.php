...
class HostileSpawnAsyncTask extends BaseAsyncSpawnTask{
	...
	public function onRun(){
		...
		foreach($chunks as $chunk){
			if(ItemFactory::get($chunk->getBlockId(\kenygamer\Core\Main::mt_rand(0,15), \kenygamer\Core\Main::mt_rand(0 , 255), \kenygamer\Core\Main::mt_rand(0,15))) instanceof Solid){
				continue;
			}
