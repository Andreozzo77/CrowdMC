...
class ProtectedArea{
	...
	public function contains(Vector3 $pos, string $levelName) : bool{
		return ((min($this->pos1->getX(), $this->pos2->getX()) <= $pos->getFloorX()) && (max($this->pos1->getX(), $this->pos2->getX()) >= $pos->getFloorX()) && (min($this->pos1->getY(), $this->pos2->getY()) <= $pos->getFloorY()) && (max($this->pos1->getY(), $this->pos2->getY()) >= $pos->getFloorY()) && (min($this->pos1->getZ(), $this->pos2->getZ()) <= $pos->getFloorZ()) && (max($this->pos1->getZ(), $this->pos2->getZ()) >= $pos->getFloorZ()) && ($this->levelName === $levelName));
	}
	/**
	 * @param string $flag
	 *
